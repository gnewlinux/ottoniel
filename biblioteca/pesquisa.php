...
<main role="main" class="container">
	<h1 class="mt-5">Pesquisa Biblioteca</h1>
	<p class="lead">Digite sua pesquisa:</p>
      <form name="" method="post" action="" enctype="multipart/form-data">
<p>Codigo: <input type="text" name="codigo" value="" size="10"></p>
<p>Nome do Livro: <input type="text" name="nome" value="" size="25"></p>
<p>Autor do Livro: <input type="text" name="autor" value="" size="25"></p>
<input class="input" type="submit" name="send" value="PESQUISAR">
        	...
        	<?php
					if(isset($_POST['send'])){
						...
						if($codigo == '' and $nome == '' and $autor == ''){
							echo "<script language='javascript'>window.alert('Por favor, digite em um dos campos.')</script>";
						} else {

							if($nome != ''){
							$sqlConsulta = "SELECT * FROM biblioteca WHERE nome LIKE '$nome%'";
							} else if($autor != ''){
							$sqlConsulta = "SELECT * FROM biblioteca WHERE autor LIKE '$autor%'";
							} else if($codigo != ''){
							$sqlConsulta = "SELECT * FROM biblioteca WHERE id = '$codigo'";
							}
